  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "24px" }}>
      <button onClick={() => action("toggle")} disabled={loading === "toggle"}
        style={{ width: "100%", padding: "14px", background: "#fff", border: "1px solid #e5e5e5", color: "#111", borderRadius: "12px", fontSize: "14px", fontWeight: "700", cursor: "pointer", fontFamily: "Cairo, system-ui, sans-serif" }}>
