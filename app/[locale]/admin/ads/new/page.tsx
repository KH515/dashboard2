    ...
    <div style={{ minHeight: "100vh", background:"#EEEEEE", color: "#111", fontFamily: "Cairo, system-ui, sans-serif", direction: "rtl" }}>
      <div style={{ padding: "16px 20px", borderBottom: "1px solid #e5e5e5", display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, background:"#EEEEEE", zIndex: 10 }}>
        ...
        <button type="button" onClick={() => setPreview(!preview)}
          style={{ background: "transparent", border: "1px solid #e5e5e5", color: "#111", padding: "6px 14px", borderRadius: "8px", cursor: "pointer", fontSize: "12px", fontFamily: "Cairo, system-ui, sans-serif" }}>
      ...
      <div style={{ padding: "24px 16px", maxWidth: "500px", margin: "0 auto" }}>
        {preview ? (
          <div>
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e5e5", borderRadius: "16px", overflow: "hidden", marginBottom: "16px" }}>
              {form.image && (
              ...
              <div style={{ padding: "16px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                  ...
                  <span style={{ background: "#f0f0f0", border: "1px solid #e5e5e5", padding: "3px 10px", borderRadius: "20px", fontSize: "11px", flexShrink: 0, marginRight: "8px" }}>{targetLabel}</span>
                </div>
            ...
            <button type="button" onClick={() => setPreview(false)}
              style={{ width: "100%", marginBottom: "10px", padding: "14px", background: "transparent", border: "1px solid #e5e5e5", color: "#111", borderRadius: "12px", fontSize: "14px", fontWeight: "700", cursor: "pointer", fontFamily: "Cairo, system-ui, sans-serif" }}>
              ← رجوع للتعديل
            </button>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              <button type="button" onClick={() => fileRef.current?.click()} disabled={uploading}
                style={{ width: "100%", padding: "13px 16px", background: "#fff", border: "1px dashed #333", borderRadius: "12px", color: uploading ? "#555" : "#fff", fontSize: "14px", cursor: "pointer", fontFamily: "Cairo, system-ui, sans-serif", textAlign: "center" }}>
                {uploading ? "جاري الرفع..." : form.image ? "تغيير الملف" : "اضغط لرفع صورة أو فيديو"}
              </button>
              {form.image && (
                <div style={{ marginTop: "8px", borderRadius: "10px", overflow: "hidden", border: "1px solid #e5e5e5", position: "relative" }}>
                  {isVideo ? (
                  ...
                  <button type="button" onClick={() => setForm({...form, image: ""})}
                    style={{ position: "absolute", top: "8px", left: "8px", background: "rgba(0,0,0,0.7)", border: "none", color: "#111", borderRadius: "50%", width: "28px", height: "28px", cursor: "pointer", fontSize: "14px" }}>
                    ×
                  </button>
                </div>
              )}
