  ...
  return (
    <div style={{ display: "flex", gap: "8px" }}>
      <button onClick={() => action("toggle")} disabled={loading === "toggle"}
        style={{ background: "#f0f0f0", border: "1px solid #e5e5e5", color: "#111", padding: "5px 12px", borderRadius: "8px", fontSize: "12px", fontWeight: "600", cursor: "pointer", fontFamily: "Cairo, system-ui, sans-serif" }}>
