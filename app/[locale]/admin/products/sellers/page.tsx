          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {sellers.map((seller: any) => (
              <Link key={seller.id} href={"/admin/products/sellers/" + seller.username} style={{ textDecoration: "none" }}>
                <div style={{ background: "#fff", border: "1px solid #e5e5e5", borderRadius: "14px", padding: "14px 16px", display: "flex", alignItems: "center", gap: "12px" }}>
                  <div style={{ width: "44px", height: "44px", borderRadius: "50%", background: "#f0f0f0", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "800", fontSize: "18px", flexShrink: 0 }}>
