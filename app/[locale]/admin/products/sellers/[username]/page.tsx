...
async function getSellerProducts(token: string, username: string) {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/sellers/${username}`, {
  ...
  return (
    <div style={{ minHeight: "100vh", background:"#EEEEEE", color: "#111", fontFamily: "Cairo, system-ui, sans-serif", direction: "rtl" }}>
      ...
      <div style={{ padding: "16px", maxWidth: "700px", margin: "0 auto" }}>
        {seller && (
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px", padding: "14px 16px", background: "#fff", borderRadius: "14px", border: "1px solid #e5e5e5" }}>
            <div style={{ width: "44px", height: "44px", borderRadius: "50%", background: "#f0f0f0", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "800", fontSize: "18px" }}>
