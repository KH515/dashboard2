  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/auth/login", {
        ...
        body: JSON.stringify({ identifier, password, expectedRole: "affiliate" }),
      })
          ...
          {step === "login" ? (
            <>
              <div style={{ marginBottom: "32px" }}>
                ...
                <h1 style={{ fontSize: "26px", fontWeight: "800", marginBottom: "8px" }}>برنامج العمولة</h1>
                <p style={{ color: "#444", fontSize: "14px" }}>تابع عمولاتك ومبيعاتك وأرباحك</p>
              </div>
