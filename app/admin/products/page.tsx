            ...
            {filtered.map((product: any) => {
              ...
              return (
                <div key={product.id} onClick={() => router.push("/admin/products/" + product.id)}
                  style={{ background: "#111", border: "1px solid #1a1a1a", borderRadius: "14px", overflow: "hidden", cursor: "pointer", position: "relative", filter: inactive ? "grayscale(1)" : "none", opacity: inactive ? 0.6 : 1 }}>
                  {inactive && (
