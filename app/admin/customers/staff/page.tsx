      ...
      <div style={{ display: "flex", gap: "4px", padding: "12px 16px", borderBottom: "1px solid #111", overflowX: "auto" }}>
        {tabs.map(tab => (
          <Link key={tab.href} href={tab.href} style={{ textDecoration: "none" }}>
            <div style={{ padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: "600", whiteSpace: "nowrap", background: tab.role === "staff" ? "#fff" : "#111", color: tab.role === "staff" ? "#000" : "#555", border: "1px solid #222" }}>
              {tab.label}
            </div>
          </Link>
        ))}
